...
\begin{tikzpicture}[remember picture,overlay]
  ...
  {\begin{tikzpicture}[remember picture,overlay]
      \node[anchor=north west,inner sep=0pt] at (0,0){ \resizebox{!}{30cm}{\includegraphics[width=\paperwidth]{back2}}}; % Background image
      \draw[anchor=north] (midpoint) node [fill=ocre!15!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\Huge\centering \textsf{Rapport de stage de fin d'études} \\[15pt] % Book title
...
\begin{figure}[H]
	\centering
	\itshape
	\includegraphics[width=15cm,height=12cm]{script_apt.png}
